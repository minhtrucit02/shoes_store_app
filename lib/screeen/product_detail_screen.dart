    ...
    return Scaffold(
      ...
      body: productAsync.when(
        data: (product) {
          ...
          final getImageKey =
              ref.watch(selectedImageProductProvider) ??
          ...
          return productSizeAsync.when(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final imageUrl =
                                    product.listImageProduct[imageKey]?.url ??
                                    '';
                                return GestureDetector(
                                  onTap: () {
                                    ref
                                        .read(
                                          selectedImageProductProvider.notifier,
                                        )
                                        .state = imageKey;
                                  },
                                  child: Container(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isAvailable = sizes.contains(size);
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              final cartItem = CartItem(
                                ...
                                productImage: product.listImageProduct[getImageKey]?.url ?? '',
                              ...
                              try{
                                await ref.watch(addCartItemProvider(cartItem).future);
            ...
            error:
                (e, _) => const Center(child: Text("Không thể tải sản phẩm")),
          );
        },
        loading: () => const Center(child: CircularProgressIndicator()),
